...
- Name: Authentication Tests >> auth page has responsive design
- Location: /Users/taylormohney/Documents/GitHub/practicedemo/e2e/auth.spec.ts:46:7
...
Call log:
  ...
  - waiting for locator('.auth-provider')
    ...
    at /Users/taylormohney/Documents/GitHub/practicedemo/e2e/auth.spec.ts:64:50
```
